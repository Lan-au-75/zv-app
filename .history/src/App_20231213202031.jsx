...
export default function App() {
    ...
    const post1Comments = formatComments?.filter((comment) => comment.postId === 1)
    const post2Comments = formatComments?.filter((comment) => comment.postId === 2)

    console.log('Comments for Post 1:', post1Comments)
    console.log('Comments for Post 2:', post2Comments)
